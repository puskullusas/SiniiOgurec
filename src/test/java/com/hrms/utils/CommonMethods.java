...
import com.hrms.testbase.PageInit;
...
public class CommonMethods extends PageInit {
	 ...
	 * @param fileName
	 */
	public static byte[] takeScreenshoti(String fileName) {
		//to add date to screentshot
		Date date = new Date();
		...
		File file = ts.getScreenshotAs(OutputType.FILE); //to store screenshots in separate folder
		String screenshotPath = Constants.SCREENSHOTS_PATH+ fileName + timeStamp+".png";
	...
	/**
	 * This method will read JSON and convert into String
	 * @param fileName
	 */
